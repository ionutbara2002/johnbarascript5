...
@echo off & title Gallery Iron - Daia and MAgda
...
:menu 
set "?=Conifg Daia and Magda,+ Config Madga,+ Config Daia,+ Update Daia,+ Update Magda (if you had Intel)"
set "$=" & call :choices $ "%?%" 0 "Gallery Iron (Security Vulnerabilities) Manager" 15 0xff520018 Snow 500
if not defined $ exit
call :menu%$%
echo Reboot required to apply changes..
goto :menu loop

:menu1 Conifg Daia and Magda
...
:menu5 Update Magda (if you had Intel)
